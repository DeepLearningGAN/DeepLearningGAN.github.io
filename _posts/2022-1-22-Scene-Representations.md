...
*Figure 5 : An overview of a model {% cite 3D-R2N2 %} that takes a sequence of images (or just one image) from arbitrary viewpoints of a scene and generates voxelized 3D reconstruction as output.*
